    ...
    return (
        <div className="aspect-[24/24] grow min-h-px min-w-px overflow-clip relative shrink-0">
            <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 flex items-center justify-center">
                <div className="w-7 h-7 bg-gradient-to-br from-blue-500 via-blue-600 to-green-500 rounded-lg flex items-center justify-center shadow-lg shadow-blue-500/30 transition-all duration-300 hover:scale-110 hover:shadow-blue-500/50">
...
function BrandBadge() {
    return (
        <div className="relative shrink-0 w-full group">
            <div className="flex items-center p-2 w-full rounded-lg transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-500/10 hover:to-green-500/10">
                <div className="h-10 w-10 flex items-center justify-center">
                    <DevTrackLogoSquare />
                </div>
                <div className="px-3 py-1">
                    <div className="font-['Lexend:Bold',_sans-serif] text-[15px] text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400 group-hover:from-blue-300 group-hover:to-green-300 transition-all duration-300">
                        DevTrack
                    </div>
                    <div className="font-['Lexend:Regular',_sans-serif] text-[10px] text-neutral-400 -mt-0.5 tracking-wider">
                        AFRICA
                    </div>
                </div>
            </div>
...
function AvatarCircle() {
    return (
        <div className="relative rounded-full shrink-0 size-8 bg-gradient-to-br from-blue-600 to-green-600 shadow-lg shadow-blue-500/30 transition-all duration-300 hover:scale-110 hover:shadow-blue-500/50">
...
function SearchContainer({ isCollapsed = false }: { isCollapsed?: boolean }) {
    ...
    return (
        ...
        >
            <div
                className={`bg-neutral-900 h-10 relative rounded-lg flex items-center transition-all duration-500 ${isCollapsed ? "w-10 min-w-10 justify-center" : "w-full"
            ...
            >
                <div
                    ...
                    style={{ transitionTimingFunction: softSpringEasing }}
                >
                    <div className={`size-8 flex items-center justify-center transition-colors duration-300 ${isFocused ? 'text-blue-400' : 'text-neutral-400'}`}>
                        <SearchIcon size={16} />
                    </div>
                </div>
                ...
                >
                    <div className="flex flex-col justify-center size-full">
                        <div className="flex items-center justify-between pr-2 py-1 w-full gap-2">
                            <input
                                type="text"
                                ...
                                className="flex-1 bg-transparent border-none outline-none font-['Lexend:Regular',_sans-serif] text-[13px] text-neutral-50 placeholder:text-neutral-500 leading-[20px]"
                                tabIndex={isCollapsed ? -1 : 0}
                            />
                            {!isCollapsed && (
                                <span className="text-[10px] text-neutral-600 font-['Lexend:Medium',_sans-serif] bg-neutral-800 px-1.5 py-0.5 rounded">⌘K</span>
                            )}
                        </div>
                    </div>
                </div>
...
function IconNavButton({
    ...
    return (
        <aside
            className={`bg-black flex flex-col gap-4 items-start p-4 rounded-r-2xl transition-all duration-500 h-[800px] ${isCollapsed ? "w-16 min-w-16 !px-0 justify-center" : "w-80"
                }`}
            style={{ transitionTimingFunction: softSpringEasing }}
        >
