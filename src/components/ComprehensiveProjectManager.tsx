 ...
 * Complete project management with tasks, resources, analytics, and collaboration
 */
...
interface ComprehensiveProjectManagerProps {
  project: Project;
  tasks: Task[];
...
export default function ComprehensiveProjectManager({
  project,
  tasks = [],
  milestones = [],
  currentUserId,
  ...
  onProjectUpdate,
  onProjectDelete
}: ComprehensiveProjectManagerProps) {
  ...
  const handleProjectAction = (action: string) => {
    switch (action) {
      ...
      case 'archive':
        ...
        break;
      case 'delete':
        if (confirm('Are you sure you want to delete this project? This will permanently delete all tasks and resources. This action cannot be undone.')) {
          onProjectDelete?.();
        }
        break;
    }
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <CardDescription>
                      Manage project settings, team members, and preferences
                    </CardDescription>
                  </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-2">
                      This will permanently delete the project and all associated tasks and resources.
                    </p>
                  </div>
                </div>
              </CardContent>
