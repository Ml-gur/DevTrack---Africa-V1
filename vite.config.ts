...
export default defineConfig({
  plugins: [
    ...
    ...(process.env.NODE_ENV === 'production' ? [VitePWA({
      ...
      manifest: {
        ...
        short_name: 'DevTrack',
        description: 'A productivity and project tracking app for developers in Africa.',
        theme_color: '#000000',
  ...
  resolve: {
    ...
    alias: {
      ...
      'figma:asset/ddd1cf385676275fce090e99ede83b1ffe624ba4.png': path.resolve(__dirname, './src/assets/ddd1cf385676275fce090e99ede83b1ffe624ba4.png'),
      ...
      '@radix-ui/react-popover@1.1.14': '@radix-ui/react-popover',
